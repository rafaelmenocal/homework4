...
void DrawLocalTarget(const Eigen::Vector2f& target_loc_, amrl_msgs::VisualizationMsg& msg);
void DrawGlobalTarget(const Eigen::Vector2f& target_loc_, amrl_msgs::VisualizationMsg& msg);
